...
export const APP_CONFIG = {
  appName: "CPG Scorer",                     // Display name (sidebar header, page title)
  projectName: "CPG Scoring Tools",          // Client's product name (tab bar microtext, footer)
  clientName: null as string | null,         // Client first name, or null — never render "null"
  domain: "cpg-marketing",                   // Domain (finance, health, marketplace, tech, etc.)
